...
export const FREE_DELIVERABLES = [
  {
    ...
    description:
      "We review every tool you currently use. What to cut, what to keep, and what to build custom so nothing falls through the cracks.",
    icon: "audit",
  },
  {
    title: "Revenue Leak Map",
    description:
      "A one-pager showing the 3 biggest places your business is losing money or time because of tech gaps, manual processes, or broken workflows.",
    icon: "map",
  },
];
...
export const CASE_STUDIES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Created student dashboards with real-time earnings and progress tracking",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Centralized client records linked to projects, deliverables, and timelines",
      "Real-time operational dashboard replacing fragmented spreadsheets",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Structured partner onboarding with commission tracking and payout workflows",
      "Integrated document submission and payment processing pipelines",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Custom internal logistics dashboard replacing manual record-keeping",
      "Integrated compliance checks and real-time status updates",
    ],
  },
];
...
export const TESTIMONIALS = [
  {
    name: "Sumit S.",
    context: "Founder, Trading Education Platform",
    quote:
      "Our premium courses were being redistributed and referral tracking was completely manual. They built us a secure platform with video protection and a commission engine that handles multi-level payouts automatically.",
    initials: "SS",
  },
  {
    name: "Sabuj B.",
    context: "Founder, Digital Marketing Agency",
    quote:
      "We were drowning in spreadsheets trying to manage client projects. They built a bespoke project management system with role-based access and a centralized dashboard. Team accountability improved dramatically.",
    initials: "SB",
  },
  {
    name: "Farid A.",
    context: "Founder, Financial Services Platform",
    quote:
      "Managing 25+ services across agents and clients was impossible without a platform. They designed a complete multi-role SaaS with onboarding, commission tracking, and payment workflows all under one roof.",
    initials: "FA",
  },
  {
    name: "Sunil D.",
    context: "Founder, Import-Export Business",
    quote:
      "Our export-import operations were hindered by manual tracking. They built a custom logistics system that automated our tracking and documentation. It is now the backbone of our efficiency.",
    initials: "SD",
  },
  {
    name: "Sunil K.",
