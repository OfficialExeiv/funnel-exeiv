    ...
    >
      <div className="p-4 bg-[#141018]/95 backdrop-blur-xl border-t border-white/5">
        <Link
          ...
          className="cta-glow cta-pulse flex items-center justify-center gap-2 w-full bg-[var(--brand-accent)] text-white font-heading font-bold py-4 rounded-xl text-base tracking-wide"
